...
class Paper(models.Model):
    ...
    score = models.PositiveSmallIntegerField("总分", default=710)
    choice_number = models.PositiveSmallIntegerField("选择题数", default=10)
    fill_number = models.PositiveSmallIntegerField("翻译题数", default=10)
    judge_number = models.PositiveSmallIntegerField("判断题数", default=10)
    program_number = models.PositiveSmallIntegerField("作文题数", default=1)
    ...
    def save(self, *args, **kwargs):
        self.score = (self.choice_number + self.fill_number + self.judge_number) * 20 + self.program_number * 110
