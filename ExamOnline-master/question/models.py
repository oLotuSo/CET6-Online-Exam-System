...
class Choice(models.Model):
    ...
    score = models.PositiveSmallIntegerField("分值", default=20)
...
class Program(models.Model):
    ...
    question = models.TextField("题目", max_length=600, default="")
    ...
    score = models.PositiveSmallIntegerField("分值", default=110)
    level = models.CharField("难度等级", max_length=1, choices=LEVEL_CHOICES, default='1')
